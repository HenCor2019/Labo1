...
void eliminarMisterio() {
    ...
    if(cont==0){
       ...
       cout<<"Libros eliminados con exito\n";
}
...
int main(){
    ...
    bool continuar = true, CF=false;
    do{
        int opcion = 0;
        cout << "Menu: \n\t1) Agregar Libro\n\t2) Ver Libros"
        << "\n\t3) Eliminar libro\n\t4) Buscar Libro"
        << "\n\t5) Buscar Libros en Espanol\n\t6) Exisitencia libros de Ciencia Ficcion\n\t7) Eliminar Libros del Misterio\n\t8) Salir\n\tOpcion elegida: ";
        cin >> opcion;
        switch(opcion){
            ...
            case 5: cout << "Buscando..." << endl;
                 (verificarES() ? "Existen libros en espanol\n":"No existen en espanol\n");
				 break;
            case 6: CF=verificarCF(); cout << "Buscando..." << endl;
                   if(CF)
                     cout<<"Existen libros de Ciencia Ficcion\n";
                   else
                     cout<<"No existen de Ciencia Ficcion\n";
                break;
