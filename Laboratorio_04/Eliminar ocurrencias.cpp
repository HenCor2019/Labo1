//Elimina las ocurrencias de un numero
#include<iostream>
#include<windows.h>//Esta libreria solo sirve en devc++ no se porque, de lo contrario da error siempre me da error
using namespace std;
...
void Remover(int num, int cantidad){
 ...
 cout<<"Ocurrencias de: "<<num<<" eliminadas con exito\n";
 system("pause");
}
