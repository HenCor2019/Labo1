//Invierte algo, en este caso numeros
#include<iostream>
#include<windows.h>//Esta libreria solo sirve en devc++, de lo contrario da error
using namespace std;

int op=0; //No se me ocurrio otra forma, la ocupo cuando invierto, para no hacer una funcion extra
...
void mostrarLista(){
	if(pInicio==NULL)
	  cout<<"Tu lista aun esta en espera...\n";
