//Henry Alexander AMmaya 00095119
//Carlos Roberto Iraheta 00204119
...
// Conociendo la profundidad de un arbolito
int ProfundidadArbol(Arbol a){
//Verifica si aun hay elementos	
	if(a!=NULL){
//Se declara una variable contador por cada lado del arbol, se suman consecutivamente
		int izq=ProfundidadArbol(a->izq)+1;
		int der=ProfundidadArbol(a->der)+1;
//Se retorna el valor mayo
		if(izq>der)
		  return izq;
		return der;  
	}
...
int main(){
    ...
    do{
        ...
        switch(opcion){
            ...
            break;
            case 3: cout<<"La profundidad de tu arbol es: "<<ProfundidadArbol<<endl;
            break;
